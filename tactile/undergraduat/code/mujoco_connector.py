    ...
    def _edit_hands(self, spec: mj.MjSpec, hands: tuple[Hand, Hand]):
        for hand in hands:
            ...
            if hand_body is None:
                raise ValueError(f"Body not found in MJCF: {hand.side}_hand")
